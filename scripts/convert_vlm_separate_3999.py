#!/usr/bin/env python3
"""
Convert soarm-pi05-vlm_separate-3999 JAX checkpoint to PyTorch safetensors.

This is a newer S2 checkpoint trained with separate VLM loss.
"""
...
CHECKPOINT_DIR = str(Path.home() / ".cache/lerobot/hf/soarm-pi05-vlm_separate-3999")
OUTPUT_PATH = str(Path.home() / ".cache/lerobot/converted/soarm-pi05-vlm_separate-3999-pytorch")
